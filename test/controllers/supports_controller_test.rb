...
class SupportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post supports_url, params: { support: { complaint_id: @support.complaint_id, description: @support.description, file: @support.file } }
    end
  ...
  test "should update support" do
    patch support_url(@support), params: { support: { complaint_id: @support.complaint_id, description: @support.description, file: @support.file } }
